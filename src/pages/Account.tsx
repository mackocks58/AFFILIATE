  ...
  return (
    <Shell>
      <div style={{ padding: "16px 0 24px", textAlign: "center", marginBottom: 24, background: "linear-gradient(180deg, rgba(56, 189, 248, 0.08), transparent)", borderRadius: "var(--radius)" }}>
        <div className="breathe" style={{ width: 80, height: 80, borderRadius: "50%", background: "linear-gradient(135deg, var(--accent), var(--accent2))", margin: "0 auto 16px", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 32, fontWeight: 800, color: "var(--text)", boxShadow: "0 8px 24px rgba(56, 189, 248, 0.3)" }}>
      ...
      <div className="split">
        <div className="card" style={{ borderTop: "3px solid var(--accent)" }}>
          <div className="card-body">
            ...
            <div className="field" style={{ marginBottom: 16 }}>
              ...
              <div className="input" style={{ background: "rgba(5, 8, 22, 0.7)", padding: "12px 16px", fontSize: 15 }}>
        ...
        <div className="grid" style={{ gap: 16, alignContent: "start" }}>
          <div className="card" style={{ background: "linear-gradient(135deg, rgba(56, 189, 248, 0.1), rgba(5, 8, 22, 0.95))", borderColor: "rgba(56, 189, 248, 0.2)" }}>
            <div className="card-body">
              <h2 style={{ margin: "0 0 16px", fontSize: 18, display: "flex", alignItems: "center", gap: 8 }}>
                <span>🌟</span> Social Activity
              </h2>
              <div className="row" style={{ gap: 24 }}>
                <div style={{ flex: 1, background: "rgba(5, 8, 22, 0.85)", padding: 16, borderRadius: 12, border: "1px solid var(--stroke)", textAlign: "center" }}>
          ...
          <div className="card" style={{ background: "linear-gradient(135deg, rgba(56, 189, 248, 0.1), rgba(5, 8, 22, 0.95))", borderColor: "rgba(56, 189, 248, 0.2)" }}>
            <div className="card-body">
              <h2 style={{ margin: "0 0 16px", fontSize: 18, display: "flex", alignItems: "center", gap: 8, color: "var(--text)" }}>
                <span>✨</span> Affiliate Program
              </h2>
              <p className="muted" style={{ marginBottom: 16, fontSize: 14 }}>
                Invite your friends to EAGLE STAR and earn commissions for every successful registration!
              </p>
              <Link to="/affiliate" className="btn" style={{ display: "block", textAlign: "center", background: "linear-gradient(135deg, rgba(56,189,248,0.15), rgba(161,98,7,0.3))", borderColor: "rgba(56,189,248,0.5)", color: "var(--text)", fontWeight: 700, padding: "12px" }}>
