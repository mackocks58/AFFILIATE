...
export function Shell({ children }: { children: ReactNode }) {
  ...
  return (
    <div className="shell">
      ...
      {/* Sidebar */}
      <div style={{ position: "fixed", top: 0, left: sidebarOpen ? 0 : -300, width: 280, height: "100%", background: "linear-gradient(180deg, #111b33, #050816)", zIndex: 9999, transition: "left 0.3s ease", borderRight: "1px solid var(--stroke)", padding: 24, display: "flex", flexDirection: "column" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
          <Link to="/" onClick={() => setSidebarOpen(false)} style={{ color: "var(--text)", textDecoration: "none", fontSize: 18, fontWeight: 600 }}><i className="fa-solid fa-home" style={{ width: 30, color: "var(--accent)" }}></i> Dashboard</Link>
          <Link to="/bind-account" onClick={() => setSidebarOpen(false)} style={{ color: "var(--text)", textDecoration: "none", fontSize: 18, fontWeight: 600 }}><i className="fa-solid fa-link" style={{ width: 30, color: "var(--accent2)" }}></i> Bind Account</Link>
          <Link to="/withdraw" onClick={() => setSidebarOpen(false)} style={{ color: "var(--text)", textDecoration: "none", fontSize: 18, fontWeight: 600 }}><i className="fa-solid fa-money-bill-wave" style={{ width: 30, color: "var(--danger)" }}></i> Withdraw</Link>
